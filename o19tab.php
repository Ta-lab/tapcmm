...
<body>
	...
	<div  align="center"><br>
		...
		<h4 style="text-align:center"><label> SUB-CONTRACT STOCK REPORT  [ O19 ]</label></h4>
			...
			<div class="find">
				<label>S/C CODE</label>
						...
						function reload(form)
						{
							...
							self.location='o19tab.php?scc='+s0+'&pn='+s1;
						}
					</script>
			</div>
			...
			<div class="find1">
				<label>PART NUMBER</label>
						...
						function reload1(form)
						{
							...
							self.location='o19tab.php?scc='+s0+'&pn='+s1+'&f='+s2+'&tt='+s3;
						}
					</script>
			</div>
