...
if(isset($_POST['alfaok']))
{
	...
	/*if(isset($_POST['prcno']))
	{
		...
		if(substr($rc,0,1)=="E")
		{
			...
			mysqli_query($con,"INSERT INTO `dc_det` (`dcnum`, `dcdate`, `scn`, `pn`, `mot`, `qty`, `rate`, `per`, `value_percentage`, `uom`, `basicvalue`, `cgst`, `sgst`, `igst`, `cgstamount`, `sgstamount`, `igstamount`, `totalvalue`, `vehiclenumber` ) VALUES ('$dc', '$tdate', '$sc', '$pn', '$mot', '$tiqty', '$rate', '$per', '$valuepercentage', '$uom', '$basicvalue', '$cgst', '$sgst', '$igst', '$cgstamt', '$sgstamt', '$igstamt', '$totalvalue', '$vno');");
			//echo "INSERT INTO `dc_det` (`dcnum`, `dcdate`, `scn`, `pn`, `mot`, `qty`, `rate`, `per`, `uom`, `basicvalue`, `cgst`, `sgst`, `igst`, `cgstamount`, `sgstamount`, `igstamount`, `totalvalue`, `vehiclenumber` ) VALUES ('$dc', '$tdate', '$sc', '$pn', '$mot', '$tiqty', '$rate', '$per', '$uom', '$basicvalue', '$cgst', '$sgst', '$igst', '$cgstamt', '$sgstamt', '$igstamt', '$totalvalue', '$vno');";
	...
	//else
	{
		...
		//mysqli_query($con,"INSERT INTO `dc_det` (`dcnum`, `dcdate`, `scn`, `pn`, `mot`, `qty`) VALUES ('$dc', '$tdate', '$sc', '$pn', '$mot', '$tiqty');");
		mysqli_query($con,"INSERT INTO `unit2_dc_det` (`dcnum`, `dcdate`, `scn`, `pn`, `mot`, `qty`, `rate`, `per`, `value_percentage`,`uom`, `basicvalue`, `cgst`, `sgst`, `igst`, `cgstamount`, `sgstamount`, `igstamount`, `totalvalue`, `vehiclenumber` ) VALUES ('$dc', '$tdate', '$sc', '$pn', '$mot', '$tiqty', '$rate', '$per', '$valuepercentage', '$uom', '$basicvalue', '$cgst', '$sgst', '$igst', '$cgstamt', '$sgstamt', '$igstamt', '$totalvalue', '$vno');");
