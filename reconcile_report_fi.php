	...
	<div style="float:right">
		...
		<script>
			function reload(form)
			{
				...
				self.location='reconcile_report_fi.php?f='+s0+'&tt='+s1;
			}
		</script>
	<br><br>	
	<div class="divclass">
			...
			echo'<table id="testTable" align="center">
				...
				*/
				...
				$query = "SELECT * FROM(SELECT dt,sp,pr,pn,eq,aq,app_by,app_status FROM `d17` WHERE dt>='$f' AND dt<='$tt' AND rej_status!='T' UNION 
						SELECT date,area,genrcno,mc_pn,0 AS eq,qty,app_by,app_status FROM `stockinitialize` WHERE date>='$f' AND date<='$tt' AND rej_status!='T' ) AS FT 
