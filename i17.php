...
<body>
	...
	function preventback()
	{
		...
		<form method="POST" action='i171.php'>	
			...
			<div>
				<label>RCNO</label>
					<input type="text" list="combo-options1" name ="rcno" id="rcno" required onchange="reload1(this.form)" value="<?php
							if(isset($_GET['rat']))
							{
								$rcno=$_GET['rat'];
								echo $rcno;
						...
						function reload1(form)
						{
							...
							self.location='i17.php?tdate='+s+'&to='+to+'&rat='+rcno;
						}	
						</script>
			</div>
			<br>
			...
			<script>
				function edValueKeyPress2()
				{
					...
					{
						document.getElementById('cls').style.display = 'none';
						alert('Excess Return Not Allowed...');
