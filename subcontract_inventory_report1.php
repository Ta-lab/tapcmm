...
LEFT JOIN(SELECT * FROM `d11`) AS Td11 ON TSUB.dcnum=Td11.rcno WHERE Td11.closedate='0000-00-00'";
				*/
				...
				$query2 = "SELECT TSUB.dcnum AS fdcnum,TSUB.date,scn,TSUB.pnum,TSUB.total_dc_qty,TSUB.total_rec_qty,TSUBINV.dcnum,IF(TSUBINV.invqty IS NULL,0,TSUBINV.invqty) AS invqty,Td12.prcno,Td12.rec,IF(TTd12.rej IS NULL,0,TTd12.rej) AS rej,Td11.rcno,Td11.closedate FROM(SELECT dcnum,date,scn,pnum,total_dc_qty,total_rec_qty FROM `subcondb`) AS TSUB
...
LEFT JOIN(SELECT * FROM `d11`) AS Td11 ON TSUB.dcnum=Td11.rcno WHERE Td11.closedate='0000-00-00' ORDER BY pnum,scn,date";
