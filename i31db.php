...
if(isset($_POST['submit']))
{
	...
	if($type=="Stores")
	{
		...
		mysqli_query($con,"INSERT INTO `stockinitialize` (`date`, `type`, `area`, `genrcno`, `mc_pn` , `supplier`, `qty`, `user`, `ip`, `app_by` , `app_status`) VALUES ('$date', '$type', '$type', '$gnum', '$partnumber' , '$sname', '$qty', '$u', '$ip', '' , 'F')");
	...
	if($type=="STOCKING POINT")
	{
		...
		mysqli_query($con,"INSERT INTO `stockinitialize` (`date`, `type`, `area`, `genrcno`, `mc_pn` , `supplier`, `qty`, `user`, `ip`, `app_by`, `app_status`) VALUES ('$date', '$type', '$area', '$gnum', '$partnumber', '' , '$qty', '$u', '$ip', '','F')");
		...
		mysqli_query($con,"INSERT INTO reconciledb (date,stkpt,pnum,prcno,partreceived,username,ip,approvedby,approvedstatus) VALUES ('$date','$area','$partnumber','$gnum','$qty','$u','$ip','','F')");
		//mysqli_query($con,"INSERT INTO d11(operation,date,pnum,rcno,closedate) VALUES('$area','$date','$partnumber','$gnum','$date')");
		mysqli_query($con,"INSERT INTO reconciledbd11(operation,date,pnum,rcno,closedate,approvedby,approvedstatus) VALUES('$area','$date','$partnumber','$gnum','$date','','F')");
	}
	if($type=="OPERATION")
	{
		$con=mysqli_connect('localhost','root','Tamil','mypcm');
		...
		mysqli_query($con,"INSERT INTO `stockinitialize` (`date`, `type`, `area`, `genrcno`, `mc_pn` , `supplier`, `qty`, `user`, `ip`, `app_by`, `app_status`) VALUES ('$date', '$type', '$area', '$gnum', '$partnumber', '' , '$qty', '$u', '$ip', '', 'F' )");
		//echo "INSERT INTO `stockinitialize` (`date`, `type`, `area`, `genrcno`, `mc_pn` , `supplier`, `qty`, `user`, `ip`, `app_by`, `app_status`) VALUES ('$date', '$type', '$area', '$gnum', '$partnumber', '' , '$qty', '$u', '$ip', '', 'F' )";
		if($rct=="A")
		{
			$rmdesc=$_POST['rmdesc'];
			//mysqli_query($con,"INSERT INTO d11(operation,date,pnum,rcno) VALUES('Stores','$date','$partnumber','$gnum')");
			mysqli_query($con,"INSERT INTO reconciledbd11(operation,date,pnum,rcno,approvedby,approvedstatus) VALUES('Stores','$date','$partnumber','$gnum','','F')");
			...
			mysqli_query($con,"INSERT INTO reconciledb(date,stkpt,rm,rmissqty,pnum,prcno,rcno,partissued,username,ip,approvedby,approvedstatus) VALUES('$date','Stores', '$rmdesc' , '$qty' , '$partnumber','','$gnum','','$u','$ip','','F')");
		}
		if($rct=="B")
		{
			//mysqli_query($con,"INSERT INTO d11(operation,date,pnum,rcno) VALUES('Semifinished1','$date','$partnumber','$gnum')");
			mysqli_query($con,"INSERT INTO reconciledbd11(operation,date,pnum,rcno,approvedby,approvedstatus) VALUES('Semifinished1','$date','$partnumber','$gnum','','F')");
			...
			mysqli_query($con,"INSERT INTO reconciledb(date,stkpt,pnum,prcno,rcno,partissued,username,ip,approvedby,approvedstatus) VALUES('$date','Semifinished1','$partnumber','','$gnum','$qty','$u','$ip','','F')");
		}
		if($rct=="C")
		{
			//mysqli_query($con,"INSERT INTO d11(operation,date,pnum,rcno) VALUES('Semifinished2','$date','$partnumber','$gnum')");
			mysqli_query($con,"INSERT INTO reconciledbd11(operation,date,pnum,rcno,approvedby,approvedstatus) VALUES('Semifinished2','$date','$partnumber','$gnum','','F')");
			...
			mysqli_query($con,"INSERT INTO reconciledb(date,stkpt,pnum,prcno,rcno,partissued,username,ip,approvedby,approvedstatus) VALUES('$date','Semifinished2','$partnumber','','$gnum','$qty','$u','$ip','','F')");
		}
		if($rct=="D")
		{
			//mysqli_query($con,"INSERT INTO d11(operation,date,pnum,rcno) VALUES('To S/C','$date','$partnumber','$gnum')");
			mysqli_query($con,"INSERT INTO reconciledbd11(operation,date,pnum,rcno,approvedby,approvedstatus) VALUES('To S/C','$date','$partnumber','$gnum','','F')");
			...
			mysqli_query($con,"INSERT INTO reconciledb(date,stkpt,pnum,prcno,rcno,partissued,username,ip,approvedby,approvedstatus) VALUES('$date','To S/C','$partnumber','','$gnum','$qty','$u','$ip','','F')");
		}
		if($rct=="E")
		{
			//mysqli_query($con,"INSERT INTO d11(operation,date,pnum,rcno) VALUES('From S/C','$date','$partnumber','$gnum')");
			mysqli_query($con,"INSERT INTO reconciledbd11(operation,date,pnum,rcno,approvedby,approvedstatus) VALUES('From S/C','$date','$partnumber','$gnum','','F')");
			...
			mysqli_query($con,"INSERT INTO reconciledb(date,stkpt,pnum,prcno,rcno,partissued,username,ip,approvedby,approvedstatus) VALUES('$date','From S/C','$partnumber','','$gnum','$qty','$u','$ip','','F')");
		}
	}
	mysqli_close($con);
