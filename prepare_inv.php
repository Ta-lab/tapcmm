    ...
    setTimeout(typeWriter, speed);
		...
		<script>
			...
			function reload0(form)
			{
				...
				self.location=<?php echo"'prepare_inv.php?tdate='"?>+p1+'&inv='+p0+'&ccode='+p;
			}
			function reload(form)
			{
				...
				self.location=<?php echo"'prepare_inv.php?tdate='"?>+p1+'&inv='+p0+'&ccode='+p+'&partnumber='+p2;
			}
			function reloadpn(form)
			{
				...
				self.location=<?php echo"'prepare_inv.php?tdate='"?>+p1+'&inv='+p0+'&ccode='+p+'&partnumber='+p2+'&pn='+pn.value;
			}
			function reloadsc(form)
			{
				...
				if (document.getElementById("pn") !=null) {
					var p3 = document.getElementById("pn").value;
					self.location=<?php echo"'prepare_inv.php?tdate='"?>+p1+'&inv='+p0+'&ccode='+p+'&partnumber='+p2+'&pn='+p3+'&sc='+p4;
				}
				else
				{
					self.location=<?php echo"'prepare_inv.php?tdate='"?>+p1+'&inv='+p0+'&ccode='+p+'&partnumber='+p2+'&sc='+p4;
				}
			}
			function reload1(form)
			{
				...
				self.location=<?php echo"'prepare_inv.php?tdate='"?>+p1+'&inv='+p0+'&ccode='+p+'&partnumber='+p2+'&cname='+p3;
			}
			function reload2(form)
			{
				...
				self.location=<?php echo"'prepare_inv.php?tdate='"?>+p1+'&inv='+p0+'&ccode='+p+'&partnumber='+p2+'&cname='+p3+'&cpo='+p4;
			}
			function preventback()
			{
				window.history.forward();
