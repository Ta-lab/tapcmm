		...
		<form id="form" name="form" method="post" action="i25db.php">
			...
			<?php
				...
				if(isset($_GET['rcno']) && $_GET['rcno']!="")
				{
					...
					//new add for cle
					$query3 = "SELECT * FROM cledb where rcno='$rcno'";
					$result3 = $con->query($query3);
					$row2 = mysqli_fetch_array($result3);
					$cle_received = $row2['received_qty'];
					$cle_issued = $row2['issued_qty'];
					$cle_rejected = $row2['rejected'];
				...
				if(isset($_GET['rcno']) && $_GET['rcno']!="")
				{
					...
					else
					{
						...
						$rej=$r3;
						//$p=$r2+$r3;
						//$p=($r2+$r3)-($cle_issued-($cle_received+$cle_rejected));
						$p=($r2+$r3)-($cle_issued-$cle_received);
					...
					$tot_rec = $r2 - ($cle_issued - $cle_received);
					
					$tot_rej = $r3;
					
					if(substr($rcno,0,1)=="A"){
						echo '<div><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TOTAL RECEIVED  : '.$tot_rec.' Nos  ( '.$tot_rec*$row1['bom'].' Kg )</label></div>';
						echo '<div><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TOTAL REJECTED  : '.$tot_rej.' Nos  ( '.$tot_rej*$row1['bom'].' Kg )</label></div>';
					}else{
						echo '<div><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TOTAL RECEIVED  : '.$tot_rec.' Nos</label></div>';
						echo '<div><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TOTAL REJECTED  : '.$tot_rej.' Nos</label></div>';
					}
