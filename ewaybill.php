...
if(isset($_POST['submit']))
{
	...
	//copy('D:\REPORT\Eway-'.$t.' @ '.date("Y-m-d").'.xlsx', '\\\192.168.1.121\c\VSS E WAY\Eway-'.$t.' @ '.date("Y-m-d").'.xlsx');
	copy('D:\REPORT\Eway-'.$t.' @ '.date("Y-m-d").'.xlsx', '\\\192.168.1.100\share documents\SALES\VSS E WAY\Eway-'.$t.' @ '.date("Y-m-d").'.xlsx');
