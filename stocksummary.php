...
<body>
	...
	<div  align="center"><br>
		...
		<h4 style="text-align:center"><label>STOCK SUMMARY</label></h4>
	...
	<div class="divclass">
			...
			<?php
				...
				while($row1 = mysqli_fetch_array($result2))
				{
					...
					echo"<tr>
					<td>".$row1['storeopen']."</h4></td></tr>";
					
					/*echo"<tr>
					<td><h4 $color>".$row1['date']."</h4></td>
					<td><h4 $color>".$row1['rmdesc']."</h4></td>
					<td><h4 $color>".$row1['inwarded']."</h4></td>
					<td><h4 $color>".$row1['accepted']."</h4></td>
					<td><h4 $color>".$row1['rejected']."</h4></td>";
