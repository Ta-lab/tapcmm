...
<body>
	...
	<div style="float:right">
		...
		<h4 style="text-align:center"><label>ORDER BOOK MASTER LIST</label></h4><br>
...
<?php
$r=0;$tt=0;
	$result = mysqli_query($con,"SELECT * FROM orderbook");
	while($row = mysqli_fetch_array($result))
	{
		echo "<tr><td>".$row['order_date']."</td><td>".$row['pnum']."</td><td>".$row['qty']."</td><td>".$row['req_date']."</td><td>".$row['ref_no']."</td><td>".$row['commit']."</td></tr>";
	}
?>
<?php
if($r>0)
