		...
		<form method="POST" action='oprecdb.php'>	
			...
			if(isset($_GET['stkpt']))
			{
				...
				{	
					...
					<td></td>
					<td><input  style='background: rgba(0,0,0,.075); width:100%; text-align:center; color:white' type='text' readonly='readonly' value='".$stk."'</td>
					</tr>";
