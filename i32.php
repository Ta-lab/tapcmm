...
<body>
	<div style="float:right">
		...
		<h4 style="text-align:center"><label> REWORK RC GENERATION </label></h4>
		<div class="divclass">
		<script>
	function preventback()
	{
		...
		<form method="POST" action='i321.php'>	
			</br>
			<div>
				<label>DATE</label>
		...
		{	
			...
			self.location='i32.php?tdate='+s+'&rat='+val;
		}
		</script>
			<br>
			<div>
				<label>PART NUMBER</label>
					...
					<option value=''>Select one</option>
						...
						{	
							...
							self.location=<?php if(isset($_GET['rat']))echo"'i32.php?tdate=".$_GET['tdate']."&rat=".$_GET['rat']."&mat='";?> + val ;
						}
						</script>
			</div>
			<br>
