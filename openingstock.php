...
<body>
	...
	<div  align="center"><br>
		...
		<h4 style="text-align:center"><label> OPENING / CLOSING STOCK</label></h4>
		...
		<label>DATE</label>
			...
			<script>
				function reload1(form)
				{
					...
					self.location='openingstock.php?t='+s3;
				}
			</script>	
	</div>
	<br><br>
	<div class="divclass">
			<?php
				...
				/*echo"<tr>
					...
					<td><h4>".round($totalweight,2)."</h4></td>";				
				echo"</tr>";*/
