...
<body style="background-image: url('img/6.jpg');">
	<div style="float:right">
		...
		<script>
			function reload0(form)
			{
				...
				self.location=<?php echo"'supinv.php?tdate='"?>+p1+'&inv='+p0+'&ccode='+p;
			}
			function reload(form)
			{
				...
				self.location=<?php echo"'supinv.php?tdate='"?>+p1+'&inv='+p0+'&ccode='+p+'&partnumber='+p2;
			}
			function reload1(form)
			{
				...
				self.location=<?php echo"'supinv.php?tdate='"?>+p1+'&inv='+p0+'&ccode='+p+'&partnumber='+p2+'&cname='+p3;
			}
			function reload2(form)
			{
				...
				self.location=<?php echo"'supinv.php?tdate='"?>+p1+'&inv='+p0+'&ccode='+p+'&partnumber='+p2+'&cname='+p3+'&cpo='+p4;
			}
		</script>
		<script>
	function preventback()
	{
		...
		?>
		<div class="divclass">
		<form action="supinvdet.php" method="post" enctype="multipart/form-data">
		<br><br>
			<div >
			...
			<div >
				...
				<input style="width: 60%; background-color:white;" type="date" readonly="readonly" id="p1" name="tdate" value="<?php
				if(isset($_GET[	'tdate']))
				{
					echo $_GET['tdate'];
				}
