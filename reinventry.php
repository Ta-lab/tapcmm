...
{
	$cori="";$inum = $_POST['inum'];$ccode = $_POST['cc'];/*$msg = $_POST['msg'];*/$tdate = date('d-m-Y', strtotime($_POST['tdate']));$pn = $_POST['pn'];$cname = $_POST['cname'];$cpono = $_POST['cpono'];$tiqty = $_POST['tiqty'];$mod = $_POST['mod'];
	...
	$six=number_format((float)((($fch['rate']*$tiqty)/$fch['per'])+(round(($fch['rate']*$tiqty*$fch['pc'])/100,2))),2, '.', '');
	...
	$uom=$fch['uom'];
	$five=number_format((float)(($fch['rate']*$tiqty*$fch['pc'])/100),2, '.', '');
	...
	mysqli_query($con, "INSERT INTO `inv_det` (`invno`, `invdt`, `invt` , `ccode` , `cname`, `cname1`, `cadd1`, `cadd2`, `cadd3`, `cgstno`, `dtname`, `dtname1`, `dtadd1`, `dtadd2`, `dtadd3`, `dtgstno`, `cpono`, `cpodt`, `mot`, `vc`, `ewbno`, `pn`, `pd`, `hsnc`, `poino`, `rate`, `per`, `uom`, `qty`, `pc`, `pcamt`, `taxgoods`, `cigst`, `sgst`, `cigstamt`, `sgstamt`, `taxtotal`, `totcigstamt`, `totsgstamt`, `invtotal`, `inwords`,`inwords1`, `cori`, `r1`, `r2`, `r3`, `r4`, `r5` , `ok` , `print`) VALUES 
	('$inum','$tdate','".date("H:i")."', '$ccode' ,'$cname1','$cname2', '$cadd1', '$cadd2', '$cadd3', '$cgstin', '$dtname', '$dtname1', '$dtadd1', '$dtadd2', '$dtadd3', '$dtgstin', '$cpono', '$cpodt', '$mot', '$vc', '', '$pn', '$pd', '$hsnc', '$poino', '$rate', '$perdisplay', '$uom', '$tiqty', '$pc', '$five1', '$six', '$sev1', '$egt1', '$vsev1', '$vegt1', '$six', '$vsev1', '$vegt1', '$amt', '$a1', '$t1', '$cori' , '$r1', '$r2', '$r3', '$r4', '$r5' , 'T' , 'F')");
