		...
		<form method="POST" action='i141.php'>	
			...
			<?php
				...
				if(isset($_GET['code']) && $_GET['code']!='' && isset($_GET['pn']) && $_GET['pn']!="")
				{
					...
					{
						$i++;
						$c[$i]=$row1['chars'];$d[$i]=$row1['drawspec'];$m[$i]=$row1['method'];$u[$i]=$row1['usl'];$l[$i]=$row1['lsl'];$ut[$i]=$row1['unit'];
					}
				}
				if(isset($_GET['code']) && $_GET['code']!='')
				{
			...
			<br><br>
				...
				<form id="form" name="form" method="post" action="i23db.php">
					...
					<?php
						...
						for($i=1;$i<10;$i++)
						{
							echo '<h5 class="h5"><label class="h5l" >'.$i.'</label><label class="h5lll" ><input style="width: 160%;" type="text" maxlength="150" name="c'.$i.'" id="c'.$i.'" value="'.$c[$i].'" '.$ss.'/></label><label style="padding-left:8%;color:#33ff99;"><input type="text" maxlength="150"style="width: 160%;"  name="d'.$i.'" id="d'.$i.'"  value="'.$d[$i].'" '.$ss.'/></label><label style="padding-left:8%;color:#33ff99;" ><input type="text" maxlength="100" style="width: 160%;"  name="m'.$i.'" id="m'.$i.'"  value="'.$m[$i].'" '.$ss.'/></label>       <label style="padding-left:8%;color:#33ff99;" ><input type="text" maxlength="50" style="width: 80%;"  name="l'.$i.'" id="l'.$i.'"  value="'.$l[$i].'" '.$ss.'/></label><label style="padding-left:1%;color:#33ff99;"><input type="text" maxlength="50" style="width: 80%;"  name="u'.$i.'" id="u'.$i.'"  value="'.$u[$i].'" '.$ss.'/></label><label style="padding-left:1%;color:#33ff99;"><input type="text" maxlength="50" style="width: 50%;"  name="ut'.$i.'" id="ut'.$i.'"  value="'.$ut[$i].'" '.$ss.'/></label></h5>';
						}
						for($i=10;$i<=50;$i++)
						{
