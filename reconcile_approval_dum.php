...
<body>
	...
	<div  align="center"><br>
		...
		<h4 style="text-align:center"><label>RECONCILATION APPROVAL</label></h4>
				...
				*/
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					*/
					...
					$link = 'APPROVE';
					echo"<td><a href='reconcile_approval_dum1.php?appdate=".$row['dt']."&link=".$link."'>APPROVE</a></td>";
					//echo"<td><a><input style='float:center;' type='button' onclick='confirmButtonClick()' name='approve' value='APPROVE'></a></td>";
					
					echo"<td><a href='reconcile_approval_dum2.php?appdate=".$row['dt']."&link="."REJECT"."'>REJECT</a></td>";
