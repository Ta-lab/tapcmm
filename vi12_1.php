...
function myFunction() {
		...
		<?php 
		echo "window.location='i12_1db.php?tdate=$tdate&stockingpoint=$stkpt&ircn=$rcno&pnum=$pnum&raw=$rm&uom=$uom&rmqty=$rmiq&inum=$inum&hno=$hno&lno=$lno&cno=$cno'";
		?>
...
<input type="button" id="cfm" value="confirm" onclick="javascript:window.print(); myFunction();  ">
