	...
	else if($n1==1)
	{
		...
		echo '<div class="tg-wrap"><table class="tg">
			  ...
			  <tr>
				...
				<td class="tg-yw4l" colspan="8">'.$row['scn'].'<br>'.$row1['sca1'].$row1['sca2'].$row1['sca3'].'<br><br>'.$row1['state'].'<br>'.$row1['sc'].'<br>'.$row1['gst'].'</td>
			  </tr>
			  <tr>
		...
		echo '<tr>
		  ...
		  <tr>
			<td class="tg-amwm" colspan="12">TOTAL VALUE IN WORS</td>
		  </tr>
		  <tr>
