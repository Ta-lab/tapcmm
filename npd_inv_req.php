				...
				<form id="form" name="form" method="post" action="npd_inv_req_db.php">
					...
					<div class="column">
						...
						<select name="type" id="type" required>
							...
							<option value="TRIAL LOT">TRIAL LOT</option>
							<option value="SAMPLE INSPECTION REPORT(SIR)">SAMPLE INSPECTION REPORT(SIR)</option>
							<option value="INITIAL SAMPLE INSPECTION REPORT(ISIR)">INITIAL SAMPLE INSPECTION REPORT(ISIR)</option>
							<option value="SAMPLE LOT AFTER SIR AND ISIR">SAMPLE LOT AFTER SIR AND ISIR</option>
							<option value="PPAP APPROVAL LOT">PPAP APPROVAL LOT</option>
							<option value="ERD SAMPLE">ERD SAMPLE</option>
						</select>
					</div>
