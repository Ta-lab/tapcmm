<?php
	if(1)
	{
		$dm=date("Y-m");
			...
			//closing stock
			$objPHPExcel->getActiveSheet()->SetCellValue('A121', 'Closing Stock(F)');
			$objPHPExcel->getActiveSheet()->SetCellValue('A122', 'Raw Material(F1)');
			$objPHPExcel->getActiveSheet()->SetCellValue('A132', 'Total(F1)');
			$objPHPExcel->getActiveSheet()->SetCellValue('A134', 'Work In Progress(F2)');
			$objPHPExcel->getActiveSheet()->SetCellValue('A143', 'Total(F2)');
			$objPHPExcel->getActiveSheet()->SetCellValue('A145', 'Finished goods(F3)');
			$objPHPExcel->getActiveSheet()->SetCellValue('A154', 'Total(F3)');
			$objPHPExcel->getActiveSheet()->SetCellValue('A156', 'Total(F)');
