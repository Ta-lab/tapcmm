...
<body>
	...
	<div class="divclass">
			...
			echo'<table id="testTable" align="center">
				...
				/*$query = "SELECT DISTINCT invpnum,SUM(useage) AS tot FROM (SELECT DISTINCT pn_st.pnum,invpnum,useage FROM pn_st LEFT JOIN m13 ON m13.pnum=pn_st.pnum) AS T0 GROUP BY invpnum";
				$result = $conn->query($query);
				$total=0;
				while($row = mysqli_fetch_array($result))
				{
