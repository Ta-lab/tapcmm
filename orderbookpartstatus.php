...
<body>
	...
	<div class="divclass">
			<?php
				...
				$query2 = "SELECT pnum,type,sum(qty) AS qty,req_date,SUM(invoiced_qty) AS inv_qty,SUM(qty)-SUM(invoiced_qty) AS bal FROM `orderbook` GROUP BY pnum,req_date";
				...
				while($row1 = mysqli_fetch_array($result2))
				{
					...
					echo"<td>".$row1['inv_qty']."</td>";
					echo"<td>".$row1['bal']."</td></tr>";
				}
