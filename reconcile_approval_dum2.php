...
<body>
	...
	<div class="divclass">
	<form id="form" name="form" method="post" action="reconcile_approval_rej_db.php">
			<?php
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					*/
					...
					if($_GET['link']=='REJECT'){
						...
						echo"<td><input class='hide' type='text' name='appdate' value=".$row['dt']." ></td>";
						
						echo"<td><a><input type='text' name='reason' id='reason' placeholder='REASON' /></a></td>";
						
						//echo"<td><a href='reconcile_approval_rej_db.php?appdate=".$row['dt']."'> CONFIRM TO REJECT</a></td>";
						
						echo"<td><a><center><input type='submit'  style='left:5%;' id='rejectbutton' name='reject' value='CONFIRM TO REJECT'></center></a></td>";
