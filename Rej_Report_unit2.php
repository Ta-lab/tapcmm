...
if(isset($_SESSION['user']))
{
	...
	if($_SESSION['user']=="123" || $_SESSION['user']=="100" || $_SESSION['user']=="107" || $_SESSION['user']=="133")
	{
...
<body>
	<div style="float:right">
		...
		<h4 style="text-align:center"><label>REJECTION REPORT UNIT 2</label></h4>
			...
			<div class="find">
				<label>FROM DATE</label>
						...
						function reload(form)
						{
							...
							self.location='Rej_Report_unit2.php?f='+s0+'&tt='+s1;
						}
					</script>
			</div>
...
GROUP BY qtyrejected,prcno,REJ.pnum,date,rsn ORDER BY date";
				...
				while($row = $result->fetch_assoc()){
					...
					*/
					...
					$weight=$row['qtyrejected']*$row['bom'];
					...
					if($row['operation'] == "alfa-n-ind-prim" || $row['operation'] == "cle unit 2")
					{
						echo"<td>VSS UNIT 2</td>";
					}else
					{
