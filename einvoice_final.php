			...
			<?php
				...
				$conn = new mysqli($servername, $username, $password, "mypcm");
					...
					while($row = $result->fetch_assoc())
					{
						...
						//FOR LMW PACKING CHARGES
						$rate_with_pack_per = ($row['rate']/$per) * $packing_percentage/100 + $rate_per;
						//$rate_with_pack_per_ro = number_format((float)($rate_with_pack_per),3,'.','');
						...
						if($row2['pc']==''){
							...
							echo"<td>".$rate_with_pack_per."</td>";
							//$gross_value = $row['qty'] * $rate_with_pack_per;
						}
