...
<header class="fixeElement">
		...
		<form method="GET"></br>
			...
			<option value="%%">ALL</option>";	
				<?php			
					...
					$query = "SELECT * from m14 where oper!='' AND oper!='ALFA N-IND PRIM'";
	...
	<?php
		...
		do{
			...
			<td>".$row['received']."</td>
			<td>".$row['rejected']."</td>
			<td>".round($row['used'],2)."</td>
			<td>".round($row['notused'],2)."</td>
			<td>".$row['unit']."</td>
			<td>".$row['days']."</td>
			<td>".$f."</td></tr>";
