...
<body>
	...
	<div  align="center"><br>
		...
		<h4 style="text-align:center"><label>STOCK HAVING MORE THAN 30 DAYS</label></h4>
	...
	<div class="divclass">
		<form method="GET">			
				...
				<label>STOCKING POINT</label>
					...
					<option value="%%">ALL</option>";	
						<?php			
						    ...
						    $query = "SELECT operation FROM m11 where opertype='STOCKING POINT' and operation!='Stores' and operation!='Rework'";
						...
						function reload1(form)
						{
							...
							if(s2=="%%")
							{
								self.location='morethan30daysstk.php';
							}
							else
							{
								self.location='morethan30daysstk.php?&rat='+s2;
							}
			...
			else
			{
				...
				//working query//$query2 = "select d11.pnum,stkpt,prcno as prc,d12.date,sum(partreceived)-sum(partissued) as s ,datediff(NOW(),d12.date) as days from d12 join d11 on d12.prcno=d11.rcno where d12.pnum!='' and stkpt!='' GROUP BY prcno,stkpt HAVING (sum(partreceived)-sum(partissued))>0";
				...
				//$query2 = "select d11.pnum,stkpt,prcno as prc,d12.date,sum(partreceived)-sum(partissued) as s ,datediff(NOW(),d12.date) as days from d12 join d11 on d12.prcno=d11.rcno where d12.pnum!='' and stkpt!='Stores' AND stkpt!='Rework' AND stkpt!='' AND datediff(NOW(),d12.date)>'30' GROUP BY prcno,stkpt HAVING (sum(partreceived)-sum(partissued))>0"; 
				$result2 = $conn->query($query2);
				while($row1 = mysqli_fetch_array($result2))
				{
...
if(isset($_GET['msg']))
{
	switch($_GET['msg']){
	case "1":
		echo "' Message : ROUTE CARD HAVING MORE THAN 30 DAYS IN STOCKINGPOINT...PLEASE CLEAR THE ROUTE CARD...';";
	break;
	default:
...
{
	echo "'Message : ROUTE CARDS HAVING MORE THAN 30 DAYS IN STOCKINGPOINT...PLEASE CLEAR THE BELOW ROUTE CARDS...';";
}
?>
var speed = 75;
