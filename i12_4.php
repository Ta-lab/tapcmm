...
<script>
	function preventback()
	{
		...
		if(isset($_POST['submit'])){
			...
			$sc = $_POST['sc'];
			header("Location: i12_2db.php?tdate=$tdate&prcno=$prcno&operation=$stkpt&ircn=$ircn&pnum=$pnum&sc=$sc&iss=$iss&ino=$ino&i=$i&tiqty=$tiqty");
		...
		if(isset($_POST['sub']))
		{
			...
			*/
			...
			if($sc == "VSS U-3")
			{
				...
				mysqli_query($con,"INSERT INTO d12(date,stkpt,pnum,prcno,rcno,partreceived,username,ip) VALUES('$tdate','FG For Invoicing','$p','$ircn','','$iss','$u','$ip')");
				mysqli_query($con,"INSERT INTO d12(date,stkpt,pnum,prcno,rcno,partissued,username,ip) VALUES('$tdate','FG For Invoicing','$p','$ircn','MTU$ircn','$iss','$u','$ip')");
				//mysqli_query($con,"INSERT INTO d11(operation,date,pnum,rcno,rmk,closedate) VALUES('$stkpt','$tdate','$p','MTU$ircn','INTRANSIT DB RC','$tdate')");
			...
			header("location: i12_4.php?tdate=$tdate&cat=$stkpt&rat=$pnum&dc=$ircn&sc=$sc&tiqty=$tiqty&rem=$rem&ino=$ino&i=$i");
		...
		<form method="POST" action='i12_4.php'>	
			...
			<br>
				<script>
					function reload2(form)
					{
						...
						self.location=<?php if(isset($_GET['cat']))echo"'i12_4.php?ino=".$_GET['ino']."&i=".$_GET['i']."&tdate=".$_GET['tdate']."&cat=".$_GET['cat']."&rat=".$_GET['rat']."&tiqty=".$_GET['tiqty']."&rem=".$_GET['rem']."&sc=".$_GET['sc']."&mat='";?>+val+'&dc='+s; ;
					}
				</script>
			<div>
			...
			<label>FROM UNIT</label>
				<input type="text" id="sc" readonly="readonly" name="sc" value="<?php
				if(isset($_GET['sc']))
				{
					echo $_GET['sc'];				
				}
