	...
	<div class="divclass">
			...
			<?php
				...
				while($row1 = mysqli_fetch_array($result2))
				{
					...
					<td><h4 $color>".$row1['sent_thr_dc']."</h4></td>
					<td><h4 $color>".$row1['used']."</h4></td>
					<td><h4 $color>".($row1['accepted']-$row1['used']-$row1['sent_thr_dc'])."</h4></td>";
