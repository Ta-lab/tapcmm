...
{
	if($_SESSION['access']=="From S/C" || $_SESSION['access']=="To S/C" || $_SESSION['access']=="FG For S/C" || $_SESSION['access']=="FG For Invoicing" || $_SESSION['access']=="Semifinished1" || $_SESSION['access']=="Semifinished2" || $_SESSION['access']=="133" || $_SESSION['access']=="NONE" || $_SESSION['access']=="ALL")
	{
		$id=$_SESSION['user'];
...
<div style="float:right">
	...
	<h4 style="text-align:center"><label>CLE PARTS RECEIPT & ROUTE CARD CLOSURE</label></h4>
	<div class="divclass">
	<script>
	...
	?>
		<form method="POST" action='unit2cle_receipt_db.php'>
			<div>
				<label>DATE</label>
		...
		<script>
			function reload0(form)
			{
				...
				self.location=<?php echo"'unit2cle_receipt.php?tdate='"?>+p1+'&mat='+p2;
			...
			<script>
				function reload(form)
				{
					...
					window.location='unit2cle_receipt.php?tdate='+s.value+'&mat='+p.value+'&cat='+val;
				}
			</script>
			<br>
			<div>
				...
				<select name ='prcno' id='prcno' required onchange='reload1(this.form)'>
					...
					<?php
						if(isset($_GET['cat'])) 
						{
							...
							else if($cat=="CLE UNIT 2")
							{
								$query2 = "SELECT * FROM `d11` where rcno LIKE '%L20%' AND pnum='$mat' AND closedate='0000-00-00'";
								$rfrc = $con->query($query2);
							}
					...
					function reload1(form)
						{
							...
							self.location=<?php if(isset($_GET['cat']))echo"'unit2cle_receipt.php?tdate=".$_GET['tdate']."&mat=".$_GET['mat']."&cat=".$_GET['cat']."&rat='";?> + val ;
						}
				</script>
			<div>
			...
			<script>
				function edValueKeyPress2()
				{
					...
					else if(stockingpoint=='CLE UNIT 2')
					{
						if(v < -0.001)
						{
							document.getElementById('cls').style.display = 'none';
				...
				<input type="text" readonly="readonly" id="issqty" name="issdate" value="<?php
					if(isset($_GET['rat']))
					{
						...
						else
						{
							...
							//$query2 = "SELECT sum(issued_qty) as pi FROM cledb where rcno='".$rat."' ";
							$result2 = $con->query($query2);
							$temp1=mysqli_fetch_array($result2);
							$na=$temp1['pi'];
						}
			...
			<?php			
				if(isset($_GET['rat'])) 
				{
					...
					$query5 = "SELECT prcno,rsn FROM d12 where rcno='$rat'";
					$ret5 = mysqli_query($con,$query5);
					$temp5 = mysqli_fetch_array($ret5);
					$reason = $temp5['rsn'];
					$dcnum = $temp5['prcno'];
						...
						echo"<tr>";
							...
							//echo"<td id='$t'>";
								if(isset($_GET['rat']))
								{
									...
									//$result1 = $con->query("SELECT (received_qty) AS rec,issued_qty AS iss FROM cledb where rcno='$rat'");
									$temp2=mysqli_fetch_array($result1);
									
									$result2 = $con->query("SELECT sum(partissued) as iss FROM d12 where rcno='$rat'");
									$temp3=mysqli_fetch_array($result2);
									...
									if($temp2['rec']!='')
									{
										echo $temp3['iss'] - $temp2['rec'] - $temp2['rej'];
									}
									else
									{
										echo "0";
	...
	<div style="display:none">
		...
		<br>
			...
			<div>
				<label name='option'>CLOSE RC </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<label>
					<br>
