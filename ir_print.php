...
{
	if($_SESSION['access']=="FI" || $_SESSION['user']=='123' || $_SESSION['user']=='125')
	{
		$id=$_SESSION['user'];
...
<div style="float:left">
	...
	<div align="right">
		...
		<div class="divclass">
	<form action="fpdf/digprint/inspreport.php" target="_blank" method="post">		
	<br><br>
	<?php			
		...
		{
			$p=$_GET['pnum'];
			$result = mysqli_query($con,"SELECT DISTINCT ccode FROM fi_detail WHERE pnum='$p'");
			echo "";
	...
	<script>
		function reload0(form)
		{
			...
			self.location=<?php echo"'ir_print.php?pnum='"?>+p2;
		}
	</script>
	<div>
	...
	<div>
		...
		<input type="text" name="ccode" list="combo-options1"/>
	</div>
	<br>
