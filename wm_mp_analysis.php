...
<body>
	...
	<div  align="center"><br>
		...
		<h4 style="text-align:center"><label> WEEKLY/MONTHLY MATERIAL PROCESSING REPORT </label></h4>
	...
	<script>
			function reload(form)
			{
				...
				self.location='wm_mp_analysis.php?f='+s0+'&tt='+s1;
			}
	</script>
	...
	<div class="divclass">
			...
			echo'<table id="testTable" align="center">
				...
				<td colspan="11"><h4>WEEKLY/MONTHLY MATERIAL PROCESSING REPORT FROM '.date('d-m-Y',strtotime($f)).' TO '.date('d-m-Y',strtotime($tt)).' </h4>
...
) AS FINISHQ ) AS PFINALQ) AS FULLFINISHQ GROUP BY operation,finalforeman,FCat ORDER BY operation,finalforeman,FCat";
