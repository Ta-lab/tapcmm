...
<div style="float:left">
	...
	<div align="right">
		...
		<div class="divclass">
	<form action="packprintu2.php"  method="post">		
	<br>
	<?php
		$ccode="";$fin="";$pnum="";$rcno="";
		$con = mysqli_connect('localhost','root','Tamil','mypcm');
	...
	<script>
			function reload(form)
			{
				...
				self.location=<?php echo"'packingu2.php?invno='"?>+p4;
			}
	</script>
	<div>
	...
	<div>
		...
		<input type="text" required name="box" value="<?php if(isset($_GET['invno'])){echo "";}else{echo "readonly";} ?>"/>
	</div>
	<br>
	<br>
