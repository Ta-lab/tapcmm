	...
	<div style="float:right">
		...
		<div class="divclass">
			...
			<?php
				...
				//old working query
				//$query = "select * from d12 where date='$d' and prcno like 'DC%' and stkpt='FG For Invoicing' AND rcno!='' AND rcno LIKE 'U%' AND partissued!='0'";
				
				$query = "SELECT * FROM(select * from d12 where date='$d' and prcno like 'DC%' and stkpt='FG For Invoicing' AND rcno!='' AND rcno LIKE 'U%' AND partissued!='0') AS Td12 
				...
				while($row = $result->fetch_assoc()){
					...
					$query = "select prcno from d12 where rcno='".$row['prcno']."'";
					//echo "select * from d12 where date='$d' and prcno not like 'D%' and stkpt='FG For Invoicing' AND rcno!='' AND rcno NOT LIKE 'D%'";
					...
					echo" <tr>
						<td>".$row['rcno']."</td><td>".$d."</td><td>".$row['pnum']."</td><td>".$row['scn']."</td><td>".$row['prcno']."</td><td>".$s."</td><td>".$row['partissued']."</td>";
					echo"</tr>";
				}
			?>
		</div>
