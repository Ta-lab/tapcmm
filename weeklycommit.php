...
<body>
	...
	<div style="float:right">
		...
		<h4 style="text-align:center"><label>WEEKLY COMMIT UPDATION</label></h4><br>
...
$d=$row['week'];
	$result = mysqli_query($con,"SELECT * FROM commit where week='$d'");
	//$result = mysqli_query($con,"SELECT * FROM commit");
	$r=$result->num_rows;
