...
function Header()
{
    ...
    $this->Cell(360,7, "- ORIGINAL", 0, 0, "C");
    // Move to the right
    $this->Cell(80);
    // Title
	$this->Line( 10	, 15, 200, 15);
	$this->Line( 10	, 15.1, 200, 15.1);
...
function addSocieteforcustomeradd( $nom, $adresse )
{
    $x1 = 10;
    $y1 = 75;
    //Positionnement en bas
...
function addSocietedeleveryadd( $nom, $adresse )
{
    $x1 = 110;
    $y1 = 75;
    //Positionnement en bas
...
function addEcheanceb( $date )
{
    ...
    $this->SetXY( $r1 + ($r2 - $r1)/2 - 5 , $y1+1 );
    $this->SetFont( "Arial", "B", 10);
    $this->Cell(10,4, "VEHICLE NO", 0, 0, "C");
    $this->SetXY( $r1 + ($r2-$r1)/2 - 5 , $y1 + 5 );
    $this->SetFont( "Arial", "", 10);
    $this->Cell(10,5,$date, 0,0, "C");
}
...
function addNumTVA1b($tva)
{
    ...
    $this->Cell(40, 4, "MODE OF TRANS", '', '', "L");
    $this->SetFont( "Arial", "", 10);
    $this->SetXY( $r1 + 3 , $y1+5 );
    $this->Cell(40, 5, $tva, '', '', "C");
}
...
function addCadreTVAs()
{
    ...
    $this->Line( $r1+116, $y1, $r1+116, $y2-12);  // avant MT TVA
    $this->Line( $r1+146, $y1, $r1+146, $y2-12);  // avant % TVA
    $this->Line( $r1+168, $y1, $r1+168, $y2-12);  // avant PORT
    //$this->Line( $r1+91, $y1, $r1+91, $y2);  // avant TOTAUX
    $this->SetXY( $r1+1, $y1);
    $this->Cell(10,4, "Rupees In Words :sdcksdmfnklsdnfkjrnfkenkjernfkemnvjerinclkdnceiunfck");
	$this->SetX( $r1+29 );
	$this->SetXY( $r1, $y1+3);
    $this->Cell(10,4, " continue");
    $this->SetX( $r1+50 );
	$this->SetFont( "Arial", "B", 8);
	//T VALUE
	$this->SetXY( $r1+125, $y1+2);
    $this->Cell(10,4, "VALUR T");
    $this->SetX( $r1+29 );
	//CG iG VALUE T
