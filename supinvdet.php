...
if(isset($_POST['submit']))
{
	...
	*/
	...
	mysqli_query($con, "INSERT INTO `inv_det` (`invno`, `invdt`, `invt`, `ccode` , `cname`, `cname1`, `cadd1`, `cadd2`, `cadd3`, `cgstno`, `dtname`, `dtname1`, `dtadd1`, `dtadd2`, `dtadd3`, `dtgstno`, `cpono`, `cpodt`, `mot`, `vc`, `ewbno`, `pn`, `pd`, `hsnc`, `poino`, `rate`, `per`, `uom`, `qty`, `pc`, `pcamt`, `taxgoods`, `cigst`, `sgst`, `cigstamt`, `sgstamt`, `taxtotal`, `totcigstamt`, `totsgstamt`, `invtotal`, `inwords`,`inwords1`, `cori`, `r1`, `r2`, `r3`, `r4`, `r5` , `sup` , `ok` , `print` , `pan_no` , `tcs` , `tcspercentage`, `document_type`, `reverse_charge`, `igst_on_intra` ) VALUES 
	('$inum','$tdate','".date("H:i")."', '$ccode' ,'$cname1','$cname2', '$cadd1', '$cadd2', '$cadd3', '$cgstin', '$dtname', '$dtname1', '$dtadd1', '$dtadd2', '$dtadd3', '$dtgstin', '$cpono', '$cpodt', '$mod', '$vc', '', '$pn', '$pd', '$hsnc', '$poino', '$rate', '$perdisplay', '$uom', '$tiqty', '$pc', '$five1', '$six', '$sev1', '$egt1', '$vsev1', '$vegt1', '$six', '$vsev1', '$vegt1', '$amt', '$a1', '$t1', '$cori' , '$r1', '$r2', '$r3', '$r4', '$r5' , '1' , 'T' , 'F' , '$pan_no' , '' , '', '$document_type', '$reverse_charge', '$igst_on_intra')");
